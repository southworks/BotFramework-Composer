...
export const buildInFunctionsMap: Map<string, FunctionEntity> = new Map<string, FunctionEntity>([
  ...
  [
    ...
    new FunctionEntity(
      ...
      ReturnType.String,
      'Hello Test: Returns new characters from a new string. Substring(sourceString, startPos, length). startPos cannot be less than 0. A length greater than source strings length will be taken as the max length of the string.'
    ),
  ],
  [
    'toLower',
